...
extract($_GET);//$id
$table='candidat';
$candidat=get_all($table);
// $candidat=get_by_id($candidat_id,$table);
 ?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title><?php echo $c['nom'],$c['prenom']?></title>
    <!-- Global stylesheets -->
    <link href="resume/css/bootstrap/bootstrap.min.css" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Saira+Extra+Condensed:100,200,300,400,500,600,700,800,900" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i,800,800i" rel="stylesheet">
    <link href="font-awesome/css/font-awesome.min.css" rel="stylesheet">
    <link href="resume/css/devicons/css/devicons.min.css" rel="stylesheet">
    <link href="resume/css/simple-line-icons/css/simple-line-icons.css" rel="stylesheet">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#page-top">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#experience">Formation</a>
                </li>
                <li class="nav-item">
    ...
    ======================================================-->
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
          <div class="my-auto" >
              ...
              <h1 class="mb-0"><?php echo $c['nom']?>
                <span class="text-primary"><?php echo $c['prenom']?></span>
              </h1>
              <p class="mb-5" style="max-width: 500px;" ><?php echo $c['apropos']?></p>
            ...
            <div class="col-md-4 col-sm-12 mt-5"> 
              <div class="contact-cont2"> 
                <div class="contact-phone contact-side-desc contact-box-desc">
                  <h3><i class="fa fa-phone cl-atlantis fa-2x"></i> Tel</h3>
                  <p><?php echo $c['tel']?>
                </div>
...
======================================================-->
    ...
    <!-- Global javascript -->
    <script src="resume/js/jquery/jquery.min.js"></script>
    <script src="resume/js/bootstrap/bootstrap.bundle.min.js"></script>
    <script src="resume/js/jquery-easing/jquery.easing.min.js"></script>
    <script src="resume/js/counter/jquery.waypoints.min.js"></script>
    <script src="resume/js/counter/jquery.counterup.min.js"></script>
    <script src="resume/js/custom.js"></script>
    <script>
